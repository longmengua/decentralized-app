...
export const TokenInformation = (p : { circulate: number, totalSupply: number, percentage: number, distributed: number, proposal?: number, vote?: number }) => {
    return <div className={'tokenInformation'}>
