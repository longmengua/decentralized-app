...
import {AddressShortCut} from "../../utils/address-short-cut";
...
export const Header = () => {
    ...
    const wallet: WalletStateI = useSelector((state: RootState) => state[WalletSliceName])
    ...
    return <div className={'header'}>
        ...
        <div className={'header__walletInfo'}>
            ...
            {
                wallet.address ? <div className={'header__walletInfo__address'} onClick={onOpen}>{AddressShortCut(wallet.address)}</div> :
